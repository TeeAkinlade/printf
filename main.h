...
int print_string(va_list types, types, char buffer[], int flags, int width);
...
int print_hexa(va_list types, char map_to[], char buffer[], int flag, int wid);
...
int write_number(int is_positiv, int ind, char buffer[], int flags, int width);
int write_pointer(char buffer[], int ind, int length, int width, int flags);
int write_num(int ind, char bff[], int flags, int width, int precision);
int write_unsgnd(int is_negativ, int ind, char buffer[], int flags, int width);
